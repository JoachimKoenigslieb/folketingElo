...
def leaderboard():
    if request.method == 'GET':
        ...
        top_N_names = [extract_name(pic) for pic in top_N]
        bottom_N_names = [extract_name(pic) for pic in bottom_N]
    
        return json.dumps({'top': top_N_names, 'bottom': bottom_N_names, 'N': N})
